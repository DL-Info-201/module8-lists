...
# Make it lowercase
  ...
  sentence <- str_to_lower("This is a long sentence of a certain number of words that I have typed")
...
# Extract the vector of letters from the resulting list
  ...
  vector.of.letters <- split.sentence[[1]]

# Use the `unique()` function to get a vector unique letters

  unique.letters <- unique(vector.of.letters)
